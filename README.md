...
<p align="center"><img src="images/12.JPG" height="400px" /></br>Attach the 3D printed bits for the insides. For the front brackets + FSR blocks, I attached them using the Dual Lock Fasteners in case I ever wanted to replace them with different heights. I superglued the back brackets, but I did notice that sometimes they would come off and I needed to reglue them. Not really a problem, just something to note. The LED diffusers don't need to be fastened as they're intended to just slide in and out of the back brackets (for easy access to potential LEDs you might want to add later).</p>
